...
public class IsiLangParser extends Parser {
	...
	public String getJavaCode() {
	    // Cria um objeto do tipo IsiLangVisitor
	    IsiLangVisitor visitor = new IsiLangVisitor();
	    
	    // Visita a raiz da árvore sintática e gera o código Java
	    visitor.visit(tree);
	    
	    // Retorna o código Java armazenado no StringBuilder do visitor
	    return visitor.getCode().toString();
	}

	public void parse() {
	    // Cria um objeto do tipo ANTLRInputStream a partir do arquivo de entrada
	    ANTLRInputStream input = new ANTLRInputStream(new FileInputStream(file));
	    
	    // Cria um objeto do tipo IsiLangLexer a partir do input
	    IsiLangLexer lexer = new IsiLangLexer(input);
	    
	    // Cria um objeto do tipo CommonTokenStream a partir do lexer
	    CommonTokenStream tokens = new CommonTokenStream(lexer);
	    
	    // Cria um objeto do tipo IsiLangParser a partir dos tokens
	    parser = new IsiLangParser(tokens);
	    
	    // Invoca a regra inicial da gramática e obtém a raiz da árvore sintática
	    tree = parser.prog();
	}