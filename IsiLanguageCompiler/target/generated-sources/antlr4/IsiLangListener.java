...
public interface IsiLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#interpretador}.
	 * @param ctx the parse tree
	 */
	void enterInterpretador(@NotNull IsiLangParser.InterpretadorContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#interpretador}.
	 * @param ctx the parse tree
	 */
	void exitInterpretador(@NotNull IsiLangParser.InterpretadorContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#highlight}.
	 * @param ctx the parse tree
	 */
	void enterHighlight(@NotNull IsiLangParser.HighlightContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#highlight}.
	 * @param ctx the parse tree
	 */
	void exitHighlight(@NotNull IsiLangParser.HighlightContext ctx);
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#apirest}.
	 * @param ctx the parse tree
	 */
	void enterApirest(@NotNull IsiLangParser.ApirestContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#apirest}.
	 * @param ctx the parse tree
	 */
	void exitApirest(@NotNull IsiLangParser.ApirestContext ctx);
	/**
